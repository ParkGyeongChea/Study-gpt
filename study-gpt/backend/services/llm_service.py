...
def analyze_intent(message: str):
    prompt = f"""
            ...
            [Intent 종류] (반드시 하나만 선택)

            1. study
            - 무엇을 배워야 하는지, 어떤 순서로 공부해야 하는지 묻는 경우

            2. explain
            - 특정 개념, 기술, 도구, 원리 등을 설명해달라는 경우
            ...
            - "설명해줘"가 포함되어 있으면,
            다른 조건보다 우선하여 explain으로 판단하라

            - 단, "커리큘럼", "학습 순서", "무엇을 배워야"가 명확하면 study
